...
import { RealtimeService, RealtimeEventService } from './realtime';
...
const startServer = async () => {
  try {
    ...
    const realtimeEventService = new RealtimeEventService(realtimeService);
    
    // Attach realtime events to app locals for use in controllers
    app.locals.realtimeEvents = realtimeEventService;
